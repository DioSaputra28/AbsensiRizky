...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
     ...
     <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-end">
            ...
            <a href="{{ route('murid.create') }}" class="btn btn-primary ml-auto"><i class="fa fa-plus" aria-hidden="true"></i></i></a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div role="group" aria-label="Contoh Biasa" class="d-flex">
                                    <a href="{{ route('murid.show', ['murid' => $item->id]) }}" class="btn btn-secondary m-1"><i class="fa-solid fa-file"></i></a>
                                    <a href="{{ route('murid.edit', ['murid' => $item->id]) }}" class="btn btn-warning m-1"><i class="fa fa-pencil" aria-hidden="true"></i></a>
