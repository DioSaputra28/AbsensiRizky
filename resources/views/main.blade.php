...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ ($title ==="Data Murid") ? 'active' : '' }}">
                <a class="nav-link collapsed" href="{{ route('murid.index') }}" data-target="#collapseTwo"
            ...
            <li class="nav-item {{ ($title ==="Absensi") ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('recap.index') }}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <div class="text-center">
                            <h4 class="text-dark active">Hari Ini: <span id="tanggal"></span></h4>
                        </div>
    ...
    <script>
        function update_tanggal() {
            ...
            tanggal.innerHTML = new Date().toLocaleDateString();
        }
    
        setInterval(update_tanggal, 1);
    </script>    
